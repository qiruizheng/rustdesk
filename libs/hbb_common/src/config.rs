...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "qiruizheng666".to_string());//密码
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["120.26.42.160"];
pub const PUBLIC_RS_PUB_KEY: &str = "JaCpXrWb44lfeZIAEg2u83uJxB1ZpZwSufcJXYujkNw=";
